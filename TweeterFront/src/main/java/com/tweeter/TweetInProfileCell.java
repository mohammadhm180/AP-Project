...
public class TweetInProfileCell extends ListCell<Tweet> {
    ...
    public VBox tweetCellCreator(Tweet tweet) throws IOException, ClassNotFoundException {
        ...
        for (Tweet retweet : Tweeter.getClient().getTweets()) {
            if(retweet instanceof Retweet){
                ...
                if(tweet instanceof Retweet){
                    if(((Retweet) retweet).getReferredTweetID().equals(((Retweet) tweet).getReferredTweetID())){
                        isRetweeted=true;
                        break;
                    }
                }
        ...
        Button deleteTweetButton = new Button("Delete");
        ...
        VBox b5 = new VBox(8.0,deleteTweetButton);
        HBox buttons = new HBox(60, b1, b2, b3, b4,b5);
        ...
        deleteTweetButton.getStylesheets().add(String.valueOf(getClass().getResource("style.css")));
        deleteTweetButton.getStyleClass().clear();
        deleteTweetButton.getStyleClass().add("button22");
            ...
            public void handle(ActionEvent actionEvent) {
                if(retweetButton.getText().equals("Retweet")){
                    ...
                    while (tweetIterator.hasNext()) {
                        ...
                        if(retweet instanceof Retweet){
                            if (((Retweet)(retweet)).getTweetID().equals(tweet.getTweetID())){
                                break;
                            }
                        }
                    }
        ...
        deleteTweetButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                String command = "removeTweet";
                try {
                    ...
                    OOS.writeObject(new String("fetchClient"));
                    OOS.writeObject(Tweeter.getClient().getUsername());
